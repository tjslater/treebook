...
class UserFriendshipsControllerTest < ActionController::TestCase
  ...
  context "#new" do
    ...
    context "when logged in" do
      ...
      should "display the friend's name" do
        ...
        assert_match /#{users(:gandalf).full_name}/, response.body
      end
    ...
    context "when logged in" do
      ...
      context "with a valid friend_id" do
        ...
        should "redirect to the profile page of the friend" do
          assert_response :redirect
          assert_redirected_to profile_path(users(:samwise))
        end
  ...
  context "#accept" do
    ...
    context "when logged in" do
      setup do
        @friend = create(:user)
        @user_friendship = create(:pending_user_friendship, user: users(:baggins), friend: @friend)
        create(:pending_user_friendship, friend: users(:baggins), user: @friend)
        sign_in users(:baggins)
